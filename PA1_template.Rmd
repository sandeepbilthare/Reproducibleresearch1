...
Mean and median of the total number of steps taken per day are `r mean_daily_steps` and `r median_daily_steps` respectively.
...
5-minute interval with id `r max_steps_interval` contains the maximum number of steps on average across all the days in the dataset.
